defmodule FirstElixirProject do
  @moduledoc """
  Documentation for FirstElixirProject.
  """
...
def selection(number_of_animals) do
  ...
  FirstElixirProject.create_zoo
  |> FirstElixirProject.randomise
  |> FirstElixirProject.see_animals(number_of_animals)
end
